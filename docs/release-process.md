...
Smells has one Rust executable and four distribution views of that executable:
...
- `@mindful-time/smells` selects one exact-version native npm package.
...
npm, and crates.io bootstrap is documented in
